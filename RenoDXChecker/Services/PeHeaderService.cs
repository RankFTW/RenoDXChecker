...
public static class PeHeaderService
{
    ...
    /// </summary>
    public static MachineType DetectArchitecture(string exePath)
    {
        try
        {
    ...
    /// </summary>
    public static string? FindGameExe(string installPath)
    {
        try
        {
    ...
    /// </summary>
    public static MachineType DetectGameArchitecture(string installPath)
    {
