...
internal static class TestHelpers
{
    ...
    private class StubShaderPackService : IShaderPackService
    {
        ...
        public void SyncDcFolder(ShaderPackService.DeployMode m) { }
        public void SyncGameFolder(string gameDir, ShaderPackService.DeployMode m) { }
        public void SyncShadersToAllLocations(IEnumerable<(string installPath, bool dcInstalled, bool rsInstalled, bool dcMode, string? shaderModeOverride)> locations, ShaderPackService.DeployMode? mode = null) { }
    }
